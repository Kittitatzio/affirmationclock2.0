...
function loadSettings() {
  const backgroundColor = localStorage.getItem("background-color") || "#364954";
  const fontColor = localStorage.getItem("font-color") || "#D4D4D4";
  const fontFamily = localStorage.getItem("font-family") || "Kode Mono";
  const customText = localStorage.getItem("custom-text") || " ";
